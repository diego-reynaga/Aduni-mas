...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            jdbcTemplate.execute("DELETE FROM usuario_roles WHERE rol_id IN (SELECT id FROM roles WHERE nombre = '' OR nombre IS NULL)");
            jdbcTemplate.execute("DELETE FROM roles WHERE nombre = '' OR nombre IS NULL");
