...
@Table(
    ...
    uniqueConstraints = @UniqueConstraint(
        name = "uk_calif_detalle_tri_matricula_curso_tri_comp_col",
        columnNames = {"matricula_id", "curso_id", "trimestre", "numero_competencia", "columna_excel"}
    ),
    indexes = {
        @Index(name = "idx_calif_detalle_tri_matricula", columnList = "matricula_id"),
        @Index(name = "idx_calif_detalle_tri_curso_periodo", columnList = "curso_id, periodo_academico_id")
    }
)
public class CalificacionDetalleTrimestre extends BaseEntity {
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "matricula_id", nullable = false, foreignKey = @ForeignKey(name = "fk_calif_detalle_tri_matricula"))
    private Matricula matricula;

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "curso_id", nullable = false, foreignKey = @ForeignKey(name = "fk_calif_detalle_tri_curso"))
    private Curso curso;

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "periodo_academico_id", nullable = false, foreignKey = @ForeignKey(name = "fk_calif_detalle_tri_periodo"))
    ...
    @JoinColumn(name = "importacion_notas_id", foreignKey = @ForeignKey(name = "fk_calif_detalle_tri_importacion"))
