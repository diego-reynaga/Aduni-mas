...
export class AdminUsers {
  ...
  async deleteRole(role: RolResponse): Promise<void> {
    if (!await this.confirmation.confirm({ title: 'Eliminar rol', message: `El rol ${role.nombre} se eliminará de forma permanente.`, confirmLabel: 'Eliminar rol', tone: 'danger' })) {
      return;
    }
